...
```{r, echo=TRUE}
        ...
        server <- function(input, output, session) {
                output$plot<-renderPlot({
                        ...
                        sql <- paste("SELECT source, sum(scoreBoolean), sum(scoreQE),
...
FROM
(
SELECT \"BC\" as source, FTS_DOC_ID, match(BC.content) against (\"" ,f(x) ," \" IN BOOLEAN MODE) as scoreBoolean,
...
UNION
SELECT \"BL\" as source, FTS_DOC_ID, match(BL.content) against (\"",f(x)," \" IN BOOLEAN MODE) as scoreBoolean,
